...
def build_onboarding_body(first_name: str, scheduling_link: str, sender_name: str) -> str:
    lines = [
        f"Hi {first_name},",
        "",
...
def main() -> int:
    ...
    if args.body_file:
        ...
        body = build_onboarding_body(args.first_name, args.scheduling_link, args.sender_name)
